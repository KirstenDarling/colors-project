...
var _resolveTypeForDocument = require("./util/resolveTypeForDocument");
...
var resolveDocumentChild = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(function* (itemId, _ref) {
    ...
    if (!type) {
      type = yield (0, _resolveTypeForDocument.resolveTypeForDocument)(itemId);
    }
    if (!type) {
      throw new _SerializeError.SerializeError("Failed to resolve document, and no type provided in parameters.", parentPath, currentSegment);
    }
  ...
  return function resolveDocumentChild(_x, _x2) {
